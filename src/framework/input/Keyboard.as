package framework.input
{
	...
	public class Keyboard extends Input
	{
		...
		public function init(visual_object:Sprite):void 
		{
			...
			//keyboard
			visual_object.stage.addEventListener(KeyboardEvent.KEY_DOWN, handleKeyDown, false, 0, false);
			visual_object.stage.addEventListener(KeyboardEvent.KEY_UP, handleKeyUp, false, 0, false);
